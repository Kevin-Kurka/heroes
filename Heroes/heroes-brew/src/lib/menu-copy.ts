...
add(COPY, ['Mimosa Bottomless', 'Bottomless Mimosa', 'Bottomless Mimosas'], 'Bottomless mimosas while you brunch.');
add(COPY, ['Blueberry Muffin Shot'], 'A blueberry muffin shot — brunch-sweet and ready for the early games.');
