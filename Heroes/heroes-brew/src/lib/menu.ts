  ...
  return [
    {
      ...
      groups: [
        ...
        // ─── SPECIALS ───
        {
          ...
          name: 'Specials',
          items: [
            { id: 'specials-i0', name: 'Mahalo Monday', description: 'Kalua Pork Sliders $4ea · Select Cans $3ea.', price: 4 },
            { id: 'specials-i1', name: 'Taco Tuesday', description: 'Tacos $4ea · Tequila $2 off.', price: 4 },
            { id: 'specials-i2', name: 'Wings & Wells Wednesday', description: 'Wings $6 off · Wells $6ea.', price: 6 },
            { id: 'specials-i3', name: 'Burgers & Beer Thursday', description: 'Burgers $5 off · Select Drafts $5ea.', price: 5 },
            { id: 'specials-i4', name: 'Friday Funday 1–4pm', description: 'Drinks and Appetizers $2 off.', price: 2 },
