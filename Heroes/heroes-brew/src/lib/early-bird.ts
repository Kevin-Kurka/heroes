/**
 * FILE: early-bird.ts
 * PURPOSE: Canonical TWO for $22 and Breakfast Happy Hour weekend facts.
 *
 * OVERVIEW:
 * Single source for the live Toast item TWO for $22 (Saturday–Sunday). Guest
 * print locked by Menu Designer: “Sat–Sun · 2 eggs any style” — not two
 * plates, not Early Bird. Breakfast Happy Hour is the same Sat–Sun window.
 * Homepage lineup, /menu Brunch + Specials, /breakfast, FAQ, and /llms.txt
 * read from here so the days and meaning cannot drift.
 *
 * DEPENDENCIES:
 * - none
 *
 ...
 * - TWO_FOR_22, TWO_FOR_22_NAME, TWO_FOR_22_PRICE, TWO_FOR_22_PRINT, TWO_FOR_22_DAILY_DEAL
 ...
 * - ✅ Sat–Sun TWO for $22 = 2 eggs any style; Breakfast Happy Hour $5
...
/** Toast POS item name — guest title. Means 2 eggs, not two plates. */
export const TWO_FOR_22_NAME = 'TWO for $22';
export const TWO_FOR_22_PRICE = '$22';
/** Menu Designer locked guest print. */
export const TWO_FOR_22_PRINT = 'Sat–Sun · 2 eggs any style';

export function twoFor22MenuDescription(): string {
  return `${TWO_FOR_22_NAME} — ${TWO_FOR_22_PRINT}.`;
}
