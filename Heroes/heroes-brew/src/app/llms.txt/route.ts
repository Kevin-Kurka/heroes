import { getRestaurantInfo, getMenus } from '@/lib/menu';
 ...
 * authoritative brief about a site. Built from the same curated data as the
 * rest of the app so the facts (hours, menu, location) never drift. Served as
 * markdown text/plain.
 */
export function GET() {
