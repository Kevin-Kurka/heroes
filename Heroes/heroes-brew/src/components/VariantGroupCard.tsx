...
import MenuCard, { DishBackdrop, PHOTO_TEXT_SHADOW } from '@/components/MenuCard';
        ...
        <div className="mb-3 flex items-baseline justify-between gap-4">
          <h2
            className={`text-lg font-semibold tracking-tight sm:text-xl ${
              usePhotoBackdrop ? `text-white ${PHOTO_TEXT_SHADOW}` : 'text-foreground'
            }`}
          >
            {group.name}
          </h2>
        ...
        {description && (
          <p
            className={`mb-5 max-w-2xl text-sm leading-relaxed ${
              usePhotoBackdrop ? `text-white/90 ${PHOTO_TEXT_SHADOW}` : 'text-muted'
            }`}
          >
            {description}
          </p>
